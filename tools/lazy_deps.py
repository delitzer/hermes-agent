...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # 2026 security fixes — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # FastAPI UploadFile/Form + 2026 parser security fixes
    ),
