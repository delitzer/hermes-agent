...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # Current 2026 OSV-clean floor; keep in sync with pyproject [web]
        "python-multipart==0.0.32",  # Current 2026 OSV-clean floor; FastAPI UploadFile/Form
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",  # Current 2026 OSV-clean floor
        "starlette==1.3.1",  # Current 2026 OSV-clean floor; keep in sync with pyproject [computer-use]
    ),
