...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # 2026 URL/UNC/method/form-limit advisories; sync with pyproject [web]
        "python-multipart==0.0.32",  # 2026 parser advisories; FastAPI UploadFile/Form (NS-501)
    ),
